    ...
    tools: [
      ...
      },
      {
        ...
        function: {
          ...
          description:
            "Submit an appointment for the patient based on the provided parameters. Make sure to include the patient's name and email, the date of the appointment, the time of the appointment, and the doctor's name.",
          parameters: {
            type: "object",
            properties: {
              name: {
